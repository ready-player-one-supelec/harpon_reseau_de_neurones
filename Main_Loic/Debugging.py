...
J = [np.array([[0.70710678],[0.70710678]]), np.array([[ 0.70710678],[-0.70710678]]), np.array([[-0.70710678],[-0.70710678]]), np.array([[-0.70710678],[ 0.70710678]]), np.array([[0.70710678],[0.70710678]])]
O = [np.array([0]), np.array([1]), np.array([0]), np.array([1]), np.array([0])]
nW = [np.array([[-4.65191674,  5.09321415],[ 5.81228623,  5.01137582],[-4.70461299,  5.1405488 ],[-4.56017898, -5.36343531], [-4.55115374, -5.3538956 ]]), np.array([[-0.94831607, -7.99318683, -0.05193885, -3.85915862, -4.67031686]])]
nB = [np.array([[ 3.81001324],[-3.89113051],[ 3.84423457],[-3.91780908],[-3.91152002]]), np.array([[4.89001659]])]
